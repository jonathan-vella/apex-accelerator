...
[`apex-iac-common/references/deploy-validation-checklist.md` § Cost monitoring inputs](../../apex-iac-common/references/deploy-validation-checklist.md#cost-monitoring-inputs-non-empty-when-enforced).
