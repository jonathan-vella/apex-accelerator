...
- **Price source verification**: are figures backed by worker-owned MCP or
	[validated direct-API evidence](pricing-guidance.md#constrained-direct-api-fallback), with truthful provenance?
