...
- Landing, Getting Started, Concepts (How It Works + Workflow), Guides (Prompt Guide,
  ...
  Agent Hooks), Reference (FAQ, Validation & Linting, Architecture Explorer,
...
>   "severity": "must_fix",
>   "category": "accuracy",
>   "description": "Agent table count disagrees with the computed manifest",
