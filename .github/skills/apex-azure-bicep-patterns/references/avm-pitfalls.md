...
[`deploy-validation-checklist.md` § KQL alert queries](../../apex-iac-common/references/deploy-validation-checklist.md#kql-alert-queries-reference-valid-columns).
...
responses. See
[`deploy-validation-checklist.md` § Entra principal object IDs](../../apex-iac-common/references/deploy-validation-checklist.md#entra-principal-object-ids-are-real).
