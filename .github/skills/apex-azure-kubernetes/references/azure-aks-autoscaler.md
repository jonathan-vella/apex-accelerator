<!-- ref:azure-aks-autoscaler-v1 -->

# AKS Cluster Autoscaler (CAS)

> The `az aks` commands below change the cluster. This skill doesn't run them: they describe the target
> configuration for the IaC owner (06b/06t) or an approved change.
