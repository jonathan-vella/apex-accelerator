...
> **Auth:** `DefaultAzureCredential` is for local development. See [auth best practices](../../../apex-entra-app-registration/references/auth-best-practices.md) for production patterns.
