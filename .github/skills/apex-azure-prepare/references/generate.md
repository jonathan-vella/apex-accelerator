...
4. ✅ Documented findings in `infra/{iac}/{project}/.azure/plan.md`
...
1. Update `infra/{iac}/{project}/.azure/plan.md` with generated file list
2. Run validation checks
3. Proceed to **apex-azure-validate** skill
