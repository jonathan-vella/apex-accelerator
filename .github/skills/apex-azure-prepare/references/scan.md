...
| ------------------------------------------------------------------------------------------- | ----------------------- |
| AWS Lambda runtime imports (`aws-lambda`, `boto3` Lambda handlers, `serverless-aws-lambda`) | **apex-azure-cloud-migrate** |

> ⚠️ If ANY match is found, **STOP and invoke that skill**. Do NOT continue with apex-azure-prepare — the skill has tested templates and patterns.
