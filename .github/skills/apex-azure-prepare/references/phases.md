...
# Phase 1 & Phase 2 Detail (apex-azure-prepare)

> Detailed step tables for the two-phase apex-azure-prepare workflow. Loaded by
> `apex-azure-prepare` SKILL.md when the agent needs the per-step references
...
| 6   | **⚠️ Hand off** — invoke **apex-azure-validate**. Prerequisite: Step 5 complete. Deployment is handled by **apex-azure-deploy**. | —                                      |
