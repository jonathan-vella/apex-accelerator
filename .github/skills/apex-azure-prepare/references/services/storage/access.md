...
Use `DefaultAzureCredential` for local development (in production, use `ManagedIdentityCredential` — see [auth-best-practices.md](../../../../apex-entra-app-registration/references/auth-best-practices.md)):
