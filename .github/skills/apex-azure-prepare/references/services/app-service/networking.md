...
> **APEX baseline:** App Service APIs are private (private endpoint, public access disabled). Public-facing web
> apps may keep public HTTPS ingress. Private DNS resolution is required for every private endpoint.
