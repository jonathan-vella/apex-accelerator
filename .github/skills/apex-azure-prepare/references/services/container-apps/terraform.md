...
> **APEX:** these raw `azurerm` examples serve the generic prepare flow. APEX Terraform CodeGen is AVM-first; see
> [`apex-terraform-patterns`](../../../../apex-terraform-patterns/SKILL.md).
