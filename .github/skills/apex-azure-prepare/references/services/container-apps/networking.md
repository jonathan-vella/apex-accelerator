...
> **APEX baseline:** use internal ingress for APIs and back ends. Use external ingress only for public-facing
> web apps, always with `allowInsecure: false`, and keep data services behind private endpoints.
