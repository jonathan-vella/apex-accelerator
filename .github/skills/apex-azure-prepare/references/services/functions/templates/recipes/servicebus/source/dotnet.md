...
> which will use your `az login` credentials. See [auth-best-practices.md](../../../../../../../../apex-entra-app-registration/references/auth-best-practices.md) for production guidance.
