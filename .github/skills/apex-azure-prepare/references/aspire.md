...
4. Proceed to **apex-azure-validate** skill
5. Deploy with **apex-azure-deploy** skill

> ⚠️ **Important for Container Apps:** If using Aspire with Container Apps, apex-azure-validate will check and help set up required environment variables after provisioning.
