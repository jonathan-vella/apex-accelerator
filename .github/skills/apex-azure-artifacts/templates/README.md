...
| Step 7: Doc Index       | `07-documentation-index.template.md`      | apex-azure-artifacts |
| Step 7: Design Doc      | `07-design-document.template.md`          | apex-azure-artifacts |
| Step 7: Runbook         | `07-operations-runbook.template.md`       | apex-azure-artifacts |
| Step 7: Inventory       | `07-resource-inventory.template.md`       | apex-azure-artifacts |
| Step 7: Cost (As-Built) | `07-ab-cost-estimate.template.md`         | apex-azure-artifacts |
| Step 7: Backup/DR       | `07-backup-dr-plan.template.md`           | apex-azure-artifacts |
| Step 7: Compliance      | `07-compliance-matrix.template.md`        | apex-azure-artifacts |
...
- ✅ Agents link to templates or reference the apex-azure-artifacts SKILL.md
