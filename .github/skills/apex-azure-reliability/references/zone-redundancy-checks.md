...
This file covers **platform-level discovery and concepts**. For service-specific assessment queries and target settings, see:
...
The APEX default region (`swedencentral`) and failover region (`germanywestcentral`) both support availability zones.
