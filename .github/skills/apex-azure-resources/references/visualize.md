...
> Loaded by the **apex-azure-resources** skill when the user asks to visualize a resource group as a Mermaid architecture diagram. Do NOT read this file unless the request is a Visualize-mode task.
...
queries — see [Azure Resource Graph Query Patterns](azure-resource-graph.md).
