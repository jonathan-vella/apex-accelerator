<!-- ref:plan-four-layer-agent-assessment-v1 -->
# Plan: 4-Layer Per-Agent Assessment Harness

Reference-only design history retained for traceability. Do not execute this
plan or treat its historical model/validator guidance as current policy.
Current operation: [agent assessment](assess-agents.md).
