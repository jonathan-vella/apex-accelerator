...
[`avm-pitfalls.md` § Log Analytics ingestion-cap alerts](../../apex-azure-bicep-patterns/references/avm-pitfalls.md#log-analytics-ingestion-cap-alerts-kql-column-safety).
...
[`cost-alerts-bicep.md` §6](../../apex-azure-defaults/references/cost-alerts-bicep.md#6-cost-anomaly-alert-subscription-scoped).
