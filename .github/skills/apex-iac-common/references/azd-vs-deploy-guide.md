...
> **See also**: [recipe-selection.md](../../apex-azure-prepare/references/recipe-selection.md)
...
| Generic app without `azure.yaml` | **azd** after approved preparation | Generic apex-azure-prepare owns manifest generation |
...
### 1. Prepare (apex-azure-prepare skill)
...
### 2. Validate (apex-azure-validate skill)
...
### 3. Deploy (apex-azure-deploy skill)
...
| Topic                                 | Location                                                                         |
| ------------------------------------- | -------------------------------------------------------------------------------- |
| Recipe selection (AZD vs Bicep vs TF) | [recipe-selection.md](../../apex-azure-prepare/references/recipe-selection.md)        |
| azd SDK quick reference               | [azd-deployment.md](../../apex-azure-deploy/references/sdk/azd-deployment.md)         |
...
| Pre-deploy checklist                  | [pre-deploy-checklist.md](../../apex-azure-deploy/references/pre-deploy-checklist.md) |
| Circuit breaker                       | [circuit-breaker.md](circuit-breaker.md)                                         |
| azure.yaml creation guide             | [azure-yaml.md](../../apex-azure-prepare/references/recipes/azd/azure-yaml.md)        |
| azd + Terraform guide                 | [terraform.md](../../apex-azure-prepare/references/recipes/azd/terraform.md)          |
