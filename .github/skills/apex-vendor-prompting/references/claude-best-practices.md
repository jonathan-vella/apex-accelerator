...
[apex-context-management skill](../../apex-context-management/SKILL.md) tier
selection.
...
- **New tokenizer produces ~30% more tokens** for the same text vs.
  ...
  [apex-context-management/references/token-estimation.md](../../apex-context-management/references/token-estimation.md)).
