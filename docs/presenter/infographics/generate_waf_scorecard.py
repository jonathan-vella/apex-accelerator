...
WAF_PILLARS = [
    ...
    {'name': 'Reliability', 'score': 8,
        'color': COLORS['reliability'], 'icon': '🛡️'},
    {'name': 'Performance', 'score': 8,
        'color': COLORS['performance'], 'icon': '⚡'},
    {'name': 'Cost Optimization', 'score': 7,
        'color': COLORS['cost'], 'icon': '💰'},
    {'name': 'Operational Excellence', 'score': 8,
        'color': COLORS['operations'], 'icon': '⚙️'},
]
...
def create_waf_scorecard():
    ...
    ax_radar.plot(angles, max_scores, 'o-', linewidth=1,
    ...
    circle = Circle(
        (10.5, 6.5), 0.8, facecolor=COLORS['primary'], edgecolor='white', linewidth=3)
    ax.add_patch(circle)
    ax.text(10.5, 6.7, f"{overall_score:.1f}", fontsize=24, fontweight='bold',
            color='white', ha='center', va='center')
    ax.text(10.5, 6.2, '/10', fontsize=12,
            color='white', ha='center', va='center')
