...
TASK_SAVINGS = [
    {'task': 'IaC Development', 'before': 6.0,
        'after': 1.5, 'color': COLORS['primary']},
    {'task': 'Documentation', 'before': 4.0,
        'after': 0.5, 'color': COLORS['success']},
    {'task': 'Troubleshooting', 'before': 3.0,
        'after': 1.0, 'color': COLORS['orange']},
    {'task': 'Code Review', 'before': 2.0,
        'after': 0.5, 'color': COLORS['purple']},
    {'task': 'Learning New Tech', 'before': 5.0,
        'after': 2.0, 'color': COLORS['accent']},
]
...
def create_roi_calculator():
    ...
    ax.add_patch(FancyBboxPatch((1.8, 0.55), 0.3, 0.2,
                                ...
                                facecolor=COLORS['light'], edgecolor=COLORS['dark'],
                                linewidth=0.5, alpha=0.5))
    ax.text(2.2, 0.65, 'Before', fontsize=7,
