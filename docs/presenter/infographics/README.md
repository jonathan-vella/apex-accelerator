...
| ---------------------------------- | ------- | ------------------------- |
| `workflow-diagram.png`             | 300 DPI | 7-step agent workflow     |
...
- 7-step "before" workflow (red)
- 7-step "after" workflow (green)
...
infographics/
├── README.md                       # This file
├── generate_workflow_diagram.py    # ⭐ 7-step agent workflow diagram
